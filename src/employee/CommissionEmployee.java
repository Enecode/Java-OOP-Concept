public abstract class CommissionEmployee extends Employee{
    ...
    public String toString() {
        return String.format("%s: %s%n%s: $%,.2f; %s: %s.2f", "Commision employee", super.toString(), "Gross sales", getGrossSales(), "Commission rate", getCommissionRate());
    }

    public abstract void setBaseSalary(double baseSalary);
}
